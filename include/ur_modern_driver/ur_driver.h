...
#include "ur_modern_driver/RG2_Grip.h"
...
public:
	...
	bool rg2Callback(ur_modern_driver::RG2::Request &req, ur_modern_driver::RG2::Response &res);
...
//    bool rg2GripDetectServer(ur_modern_driver::RG2_Grip::Request &req, ur_modern_driver::RG2_Grip::Response &res);
